...
#
# Before running this script, you need to execute the scripts
# Calculate_data_for_B_evaluation.R and, then, Evaluate_B.R,
# which write the time series of V_k and B_k_true for all the filters needed here.
#
