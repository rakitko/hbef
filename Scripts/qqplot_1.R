...
# the Gaussian (normal) approximation for the unconditional distribution x-x^f, 
# see Fig.2(right) in the supplement to the paper
#
...
# which writes the time series X_true and X_f_hbef
# needed here (see the rows with read.table(.) below).
# 
